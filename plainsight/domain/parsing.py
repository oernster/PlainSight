"""The parsed form of a document: its frontmatter block and its body.
...
EMPTY_FIELDS: Mapping[str, str] = MappingProxyType({})


@dataclass(frozen=True, slots=True)
class ParsedDocument:
    """A document split into its declared fields and its prose."""
...
def parse_document(text: str) -> ParsedDocument:
    ...
    return ParsedDocument(frontmatter=MappingProxyType(fields), body=body)
