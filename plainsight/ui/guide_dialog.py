...
def _choosing() -> str:
    ...
    return (
        ...
        "your Claude skills folder because that is where this began; take it "
        "and the plugins tree beside it comes too, as a second root. Point it "
        "anywhere else and that one folder is read, with nothing beside it "
        "touched.</p>"
