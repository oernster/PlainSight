...
def _reading() -> str:
    ...
    return (
        ...
        "<p>The count at the foot of the window says how much there is: the "
        "characters and the lines of the text you are reading. It is the text "
        "rather than the file, so a Markdown document is counted beneath the "
        "fields it declares; a PDF or a Word document is counted as what was "
        "read out of it.</p>"
