...
class DocumentRepository(Protocol):
    ...
    def read_folder(self, root: str, filter_tree: bool = True) -> Folder | None:
        ...
        While ``filter_tree`` is on, a folder named in
        ``ENVIRONMENT_FOLDER_NAMES`` is passed over and a document holding no
        text is left out; a folder left with nothing goes with them.
        """
        ...
