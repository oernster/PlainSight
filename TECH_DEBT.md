...
only been driven offscreen through its window: its screens, its footer and its
route are tested; no install, repair or removal has been performed on a real
machine.
